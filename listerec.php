...
<center>
    ...
    <tr > 
	  ...
	  <td align="right"><ul id="menu" class="topmenu" >
	            ...
	            <li class="topmenu"><a href="recette.php" style="width:52px;height:16px;line-height:16px;"><span>Recettes</span></a> 
                  <ul>
                    <li class="subfirst"><a href="plats.html">Plats</a></li>
                    <li><a href="#">Salades</a></li>
                  </ul>
                </li>
	            <li class="topmenu"><a href="categorie.html" style="height:16px;line-height:16px; "><span>Catégories</span></a> 
                  <ul>
  ...
  <table bgcolor="#FFFFFF" width="960">
    ...
    <tr> 
      <td align="center" height="400" width="480" colspan="2"><font face="Freestyle Script" size="9">Listes des recettes :</font><hr width="800" style="border-color:#666666;"/>
	  <?php 
session_start();
...
$reponses ='SELECT image,nom_rec,time,cout,diffuclte,description,nom,prenom,statut,nom_type,nom_cat FROM recettes, types, user, categories WHERE
 recettes.id_user=user.id_user AND recettes.id_type=types.id_type AND recettes.id_categorie=categories.id_categorie'; 
...
if($total){
 ...
 echo '<table bgcolor="#f1d878" width="840">'."\n";
	    ...
	    echo '<td><b>Deposé par</b></td>' ;
		 ...
		 echo '<td><b>supprimer recette</b></td>' ;
        echo '</tr>'."\n";
...
{       
		...
		echo '<td ><form action="delete.php" method="POST"><input type="submit" value="supprimer" name="delete"/ ></form></td>';
        echo '</tr>'."\n";
		$_SESSION['nom_rec']=$donnees["nom_rec"];
    }
echo '</table>'."\n";
echo"</center>";}
