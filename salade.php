...
<center>
  ...
  <table bgcolor="#FFFFFF" width="960">
    ...
    <tr> 
      <td align="center" height="400" width="480" colspan="2"><font face="Freestyle Script" size="9">Listes des salades :</font><hr width="800" style="border-color:#666666;"/>
	  <?php 
session_start();
...
$reponses ='SELECT image,nom_rec,time,cout,diffuclte,description,nom,prenom,statut,nom_type,nom_cat FROM recettes, types, user, categories WHERE
 recettes.id_user=user.id_user AND recettes.id_type=types.id_type AND types.nom_type="salade" AND recettes.id_categorie=categories.id_categorie'; 
